...
int SQLITE_NOINLINE sqlite3VdbeFinishMoveto(VdbeCursor *p){
 // printf("sqlite3VdbeFinishMoveto() called\n");
  int res, rc;
#ifdef SQLITE_TEST
...
void sqlite3VdbeRecordUnpack(
  ...
  idx += sqlite3GetTimeStampLen(aKey+idx);
  d = szHdr;
  u = 0;
  ...
  */
  if( combined_flags&(MEM_Int|MEM_Real|MEM_IntReal) ){
    ...
    if( (f1 & f2 & (MEM_Int|MEM_IntReal))!=0 ){
      ...
      //printf("compare data 1 = %lld,data 2 = %lld\n",pMem1->u.i ,pMem2->u.i );
...
int sqlite3VdbeRecordCompareWithSkip(
  ...
  ** that this routine begins comparing at the second field. */
  if( bSkip ){
    u32 stemplen = sqlite3GetTimeStampLen(aKey1+1);
    u32 s1;
    idx1 = 1 +stemplen+ getVarint32(&aKey1[1+stemplen], s1);
    szHdr1 = aKey1[0];
    ...
    idx1 = getVarint32(aKey1, szHdr1);
    idx1 += sqlite3GetTimeStampLen(aKey1+idx1);
    d1 = szHdr1;
    i = 0;
  }
...
static int vdbeRecordCompareInt(
  ...
  int serial_type = ((const u8*)pKey1)[1+sqlite3GetTimeStampLen((const u8*)pKey1+1)];
  int res;
  u32 y;
  u64 x;
  i64 v;
...
static int vdbeRecordCompareString(
  ...
  //printf("vdbeRecordCompareString\n");
  ...
  vdbeAssertFieldCountWithinLimits(nKey1, pKey1, pPKey2->pKeyInfo);
  serial_type = (u8)(aKey1[1+sqlite3GetTimeStampLen(aKey1+1)]);
  if( serial_type >= 0x80 ){
    sqlite3GetVarint32(&aKey1[1+sqlite3GetTimeStampLen(aKey1+1)], (u32*)&serial_type);
  }
  if( serial_type<12 ){
